...
<div id="pjax-container">
    ...
    <div class="lg-sidebar">
      <ul>
        ...
        <li class="lg-sidebar-item" id="musicPlayerBtn" title="音乐播放器">
            <svg class="lg-sidebar-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z" fill="#ffffff"></path></svg>
        </li>
...
<link rel="stylesheet" href="/Style/css/music-player.css?v=5.2.2">
<script>
// 确保在页面加载后初始化播放器
